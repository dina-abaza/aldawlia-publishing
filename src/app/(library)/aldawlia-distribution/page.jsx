...
const AldawliaDistributionPage = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans text-right text-gray-800 pb-24" dir="rtl">
      ...
      {/* 1. Hero Section - Updated to Dark with White Text */}
      <div className="relative bg-sky-950 py-20 border-b border-sky-900 shadow-xl">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          
          {/* زر العودة بلون ذهبي متناسق مع الخلفية الغامقة */}
          <button 
            onClick={() => router.back()} 
          ...
          <div className="space-y-4 pt-2">
            {/* العنوان الإضافي فوق العنوان الرئيسي جهة اليمين */}
            <p className="text-amber-600 font-black text-xl flex items-center gap-2 justify-start mb-2">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-16 space-y-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="bg-sky-50 p-8 rounded-3xl border border-sky-100 shadow-inner flex flex-col justify-center gap-4 text-sky-950">
        ...
        {/* Vision Section */}
        <div className="bg-sky-900 p-10 md:p-14 rounded-[3rem] shadow-xl relative overflow-hidden text-white">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Why it's important */}
          <div className="bg-white p-8 rounded-3xl border border-gray-100 space-y-8 shadow-lg hover:border-sky-100 transition-colors">
            ...
            <ul className="grid grid-cols-1 gap-4 text-xl font-bold pr-2 text-sky-900">
              {[
                ...
                <li key={index} className="flex items-center gap-3 bg-sky-50 p-4 rounded-xl border border-sky-100 hover:bg-white hover:border-gray-200 transition-colors">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                <div key={idx} className="bg-white p-5 rounded-xl border border-gray-100 shadow-md hover:border-sky-200 transition-colors">
        ...
        <div className="mt-24 text-center p-10 md:p-16 bg-sky-50 rounded-[3rem] text-sky-950 shadow-inner border border-sky-100 relative overflow-hidden group">
        ...
        {/* Final CTA Card - Navy & Amber */}
        <div className="bg-sky-950 p-12 rounded-[3rem] border border-sky-900 text-center space-y-8 shadow-2xl mt-20 relative overflow-hidden text-white">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6 pt-5 relative z-10">
                <a 
                    href={whatsappLink} 
                    target="_blank" 
                    className="flex items-center gap-3 bg-amber-500 text-sky-950 px-12 py-5 rounded-full shadow-lg hover:bg-white transition-all hover:scale-105 text-2xl font-black tracking-tighter"
                >
